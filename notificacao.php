...
try {
    ...
    // Verifica produtos prestes a vencer
    ...
    $stmt->execute([$alertDate, (new DateTime())->format('Y-m-d')]);
...
<body>
    <div class="container mt-5">
        <h1 class="text-center">Produtos a Vencer</h1>
        ...
        <?php else : ?>
            <p class="mt-4">Nenhum produto prestes a vencer.</p>
        <?php endif; ?>
